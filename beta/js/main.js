...
$(document).ready(function($){
     ...
     //$("#cl_5").css({"left":"-150%"}).animate({"left":"150%"}, "slow");
     //$("#cl_6").css({"left":"-150%"}).animate({"left":"150%"}, "slow");
     //$('#cl_6').animate({ left: '+=150' }, 400 );

     

     var windowWidth1 = jQuery(window).width();
     var finish1 = -1 * ((windowWidth1 / 2) + 500);
     var start1 = (windowWidth1 / 2) +660;
     var time1 = $("#cl_6").attr('data-time') * 1200; 
     car("#cl_6", time1);

     function car(obj1, time1) { 
            $(obj1).animate({
                'right': start1
            }, 1, function () {
                $(obj1).animate({
     ...
     var finish2 = -1 * ((windowWidth2 / 2) + 500);
     var start2 = (windowWidth2 / 2) + 660;
     var time2 = $("#cl_5").attr('data-time') * 1200; 
     var c = 1;
     offer("#cl_5", time2);
     function offer(obj2, time2) {
            $("#cl_5").removeClass();
            $("#cl_5").addClass("bg"+c);
            c++;
            $(obj2).animate({
     ...
     //Cloud Animatin start


     var windowWidth = jQuery(window).width();
     var finish = -1 * ((windowWidth / 2) + 800);
     var start = (windowWidth / 2) + 160;
    
          $('.clouds div').each(function () { 
             var time = $(this).attr('data-time') * 1000; 
    ...
    $(".rotating").textrotator({
     ...
     var clientSpeakSlider = $("#clientSpeakSlider");   
     clientSpeakSlider.owlCarousel({
         items:1,
         slideSpeed:800,
         autoplay:true,
         loop:true,
     ...
     $('#clientSpeakSlider .item').on('mouseover',function(e){
         clientSpeakSlider.trigger('stop.owl.autoplay');
     })
     $('#clientSpeakSlider .item').on('mouseleave',function(e){
         clientSpeakSlider.trigger('play.owl.autoplay');
     })

     var homebuyshowcase = $("#home-buy-showcase");   
     homebuyshowcase.owlCarousel({
         items:1,
         slideSpeed:800,
         autoplay:true,
         loop:true,
     ...
     $('#product_features .item').on('mouseover',function(e){
         product_features.trigger('stop.owl.autoplay');
     })
     $('#product_features .item').on('mouseleave',function(e){
         product_features.trigger('play.owl.autoplay');
     })

     var about_facts = $("#about_facts");   
     about_facts.owlCarousel({
         items:2,
         slideSpeed:800,
         autoplay:true,
         loop:true,
     ...
     $('#about_facts .item').on('mouseover',function(e){
         about_facts.trigger('stop.owl.autoplay');
     })
     $('#about_facts .item').on('mouseleave',function(e){
         about_facts.trigger('play.owl.autoplay');
     })
   
     // Custom Navigation Events
     $(".next").click(function(){ 
       about_facts.trigger('next.owl.carousel');
     });
     $(".prev").click(function(){
       about_facts.trigger('prev.owl.carousel');
     });
	...
	var exSlider = $("#clientSpeakSlider");
     ...
     $('.menu-smooth-scroll').scrollingTo({
		...
		callbackBeforeTransition : function(e){
			if (e.currentTarget.hash !== "") {
                    //$(e.currentTarget.hash).css("margin-top","80px");
